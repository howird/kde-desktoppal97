...
Item {
    ...
    Rectangle {
        ...
        height: width
        radius: width / 2
        color: "#000000"//softwareRendering ?  PlasmaCore.ColorScope.backgroundColor : PlasmaCore.ColorScope.textColor
    ...
    PlasmaComponents3.Label {
        ...
        anchors {
            top: icon.bottom
            topMargin: 10 //(softwareRendering ? 1.5 : 1) * PlasmaCore.Units.smallSpacing
            left: parent.left
            right: parent.right
        }
